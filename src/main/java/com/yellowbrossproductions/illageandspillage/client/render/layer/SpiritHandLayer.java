...
public class SpiritHandLayer<T extends LivingEntity> extends EyesLayer<T, SpiritHandModel<T>> {
    ...
    public SpiritHandLayer(RenderLayerParent<T, SpiritHandModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }

    public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_, float p_116987_, float p_116988_, float p_116989_, float p_116990_, float p_116991_, float p_116992_) {
        if (p_116986_ instanceof SpiritHandEntity s) {
            if (s.isGoodOrEvil()) {
