...
public class FactoryGlowLayer<T extends LivingEntity> extends EyesLayer<T, FactoryModel<T>> {
    ...
    public FactoryGlowLayer(RenderLayerParent<T, FactoryModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
