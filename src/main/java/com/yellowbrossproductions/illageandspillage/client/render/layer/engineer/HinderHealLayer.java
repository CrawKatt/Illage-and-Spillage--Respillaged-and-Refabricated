...
public class HinderHealLayer<T extends LivingEntity> extends EyesLayer<T, HinderModel<T>> {
    ...
    public HinderHealLayer(RenderLayerParent<T, HinderModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
