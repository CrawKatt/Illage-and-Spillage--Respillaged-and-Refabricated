...
public class MobSpiritGlowLayer<T extends LivingEntity> extends EyesLayer<T, MobSpiritModel<T>> {
    private static final RenderType LAYER = RenderType.eyes(new ResourceLocation("illageandspillage", "textures/entity/spiritcaller/mob_spirit.png"));

    public MobSpiritGlowLayer(RenderLayerParent<T, MobSpiritModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
