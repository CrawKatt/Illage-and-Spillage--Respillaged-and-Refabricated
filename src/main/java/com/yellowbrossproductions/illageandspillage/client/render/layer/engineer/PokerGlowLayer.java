...
public class PokerGlowLayer<T extends LivingEntity> extends EyesLayer<T, PokerModel<T>> {
    ...
    public PokerGlowLayer(RenderLayerParent<T, PokerModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
