...
public class FreakagerArmorLayer<T extends LivingEntity> extends EyesLayer<T, FreakagerModel<T>> {
    private static final RenderType LAYER = RenderType.eyes(new ResourceLocation("illageandspillage", "textures/entity/freakager/freakager_armor.png"));

    public FreakagerArmorLayer(RenderLayerParent<T, FreakagerModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
    ...
    public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (p_225628_4_ instanceof FreakagerEntity && ((FreakagerEntity) p_225628_4_).areIllagersNearby()) {
