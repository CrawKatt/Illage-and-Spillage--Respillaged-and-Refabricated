...
public class SpiritcallerFakerLayer<T extends LivingEntity> extends EyesLayer<T, SpiritcallerModel<T>> {
    private static final RenderType LAYER = RenderType.eyes(new ResourceLocation("illageandspillage", "textures/entity/spiritcaller/spiritcaller_glow.png"));

    public SpiritcallerFakerLayer(RenderLayerParent<T, SpiritcallerModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
    ...
    public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (p_225628_4_ instanceof SpiritcallerEntity && ((SpiritcallerEntity) p_225628_4_).isFaking()) {
