...
public class HinderGlowLayer<T extends LivingEntity> extends EyesLayer<T, HinderModel<T>> {
    ...
    public HinderGlowLayer(RenderLayerParent<T, HinderModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }

    @Override
    public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_, float p_116987_, float p_116988_, float p_116989_, float p_116990_, float p_116991_, float p_116992_) {
        if (p_116986_ instanceof HinderEntity hinder && !hinder.isInvisible() && !hinder.isHealing()) {
