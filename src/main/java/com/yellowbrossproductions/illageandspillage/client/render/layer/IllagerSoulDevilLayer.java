...
public class IllagerSoulDevilLayer<T extends LivingEntity> extends EyesLayer<T, IllagerSoulModel<T>> {
    ...
    public IllagerSoulDevilLayer(RenderLayerParent<T, IllagerSoulModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
