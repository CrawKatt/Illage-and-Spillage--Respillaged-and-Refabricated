...
public class OldMagispellerFakerLayer<T extends LivingEntity> extends EyesLayer<T, OldMagispellerModel<T>> {
    ...
    public OldMagispellerFakerLayer(RenderLayerParent<T, OldMagispellerModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
    ...
    public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (p_225628_4_ instanceof OldMagispellerEntity) {
            if (((OldMagispellerEntity) p_225628_4_).isFaking()) {
        ...
        } else if (p_225628_4_ instanceof FakeMagispellerEntity) {
            super.render(p_225628_1_, p_225628_2_, p_225628_3_, p_225628_4_, p_225628_5_, p_225628_6_, p_225628_7_, p_225628_8_, p_225628_9_, p_225628_10_);
        }
